<h1 align="center">Hey there 👋, I'm Devang Deokule</h1>
...
- 🌱 Expanding my skills in Java Full Stack, Spring Boot, React, Next.js, Python, Node.js, AI/ML models, and API integrations.
- ⚡ I love coding for fun, solving problems, and building side projects from small experiments to real-world solutions, including AI-powered applications, automation workflows, and full-stack projects.
- 👯 Always up for collaborating on interesting projects and contributing to open source.
- 💬 Passionate about web & app development, frontend/backend technologies, AI/ML integration, and solving tech challenges.
